...
In this analysis, I predict the net change in bike availability at each station in the [Bay Area Bike Share](http://www.bayareabikeshare.com/) system over the next hour. I accomplish this using Poisson regression models for separately predicting arrivals and departures. The parametric structure and assumptions of Poisson regression additionally enable probabilistic reasoning about the future availability of bikes.
