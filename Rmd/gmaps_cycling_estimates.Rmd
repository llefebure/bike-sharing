...
```{r dist-trip-length, warning=FALSE, message=FALSE}
...
```{r gmaps-avg-speed, warning=FALSE, message=FALSE}
...
```{r duration-diff-segmented, message=FALSE}
...
```{r duration-diff, warning=FALSE, message=FALSE}
...
```{r duration-diff-prop, warning=FALSE, message=FALSE}
...
```{r segmented-by-city, message=FALSE, warning=FALSE}
...
```{r segmented-by-distance, message=FALSE, warning=FALSE}
